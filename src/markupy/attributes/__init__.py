...
from . import _a as A
from . import _all as _
from . import _area as Area
from . import _audio as Audio
from . import _base as Base
from . import _blockquote as Blockquote
from . import _body as Body
from . import _button as Button
from . import _canvas as Canvas
from . import _caption as Caption
from . import _col as Col
from . import _colgroup as Colgroup
from . import _data as Data
from . import _del as Del
from . import _details as Details
from . import _dialog as Dialog
from . import _embed as Embed
from . import _fieldset as Fieldset
from . import _font as Font
from . import _form as Form
from . import _hr as Hr
from . import _iframe as Iframe
from . import _image as Image
from . import _img as Img
from . import _input as Input
from . import _ins as Ins
from . import _label as Label
from . import _li as Li
from . import _link as Link
from . import _map as Map
from . import _menu as Menu
from . import _meta as Meta
from . import _meter as Meter
from . import _object as Object
from . import _ol as Ol
from . import _optgroup as Optgroup
from . import _option as Option
from . import _output as Output
from . import _param as Param
from . import _progress as Progress
from . import _q as Q
from . import _script as Script
from . import _select as Select
from . import _source as Source
from . import _style as Style
from . import _table as Table
from . import _tbody as Tbody
from . import _td as Td
from . import _textarea as Textarea
from . import _tfoot as Tfoot
from . import _th as Th
from . import _thead as Thead
from . import _time as Time
from . import _tr as Tr
from . import _track as Track
from . import _video as Video
